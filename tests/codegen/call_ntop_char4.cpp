...
entry:
  ...
  %4 = getelementptr inbounds [8 x i8], [8 x i8]* %"@x_val", i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* nonnull %4)
  store [8 x i8]* %inet, [8 x i8]* %"@x_val", align 8
  %pseudo = call i64 @llvm.bpf.pseudo(i64 1, i64 1)
  %update_elem = call i64 inttoptr (i64 2 to i64 (i8*, i8*, i8*, i64)*)(i64 %pseudo, i64* nonnull %"@x_key", [8 x i8]* nonnull %"@x_val", i64 0)
